...
var Meli = function (client_id, client_secret, access_token, refresh_token) {
   ...
   /**
    ...
    this.getAuthorizationHeader = () => {
        return { Authorization: (_parameters.access_token) ? `Bearer ${_parameters.access_token}` : undefined };
    }

    this.getRequestDefaultOptions = function() {
        return {
    ...
    this.get = function (path, params, callback) {
        ...
        needle.get(path, this.getRequestDefaultOptions(), function (err, res, body) {
